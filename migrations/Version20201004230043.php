 ...
 */
final class Version20201004230043 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livres ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE livres ADD CONSTRAINT FK_927187A4A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
